...
-> Wenn das selbe Modell für unterschiedliche Mandanten zur Verfügung gestellt wird, muss es evtl. mehrfach gespeichert werden
-> Auch Modelle die aktuell nicht benötigt werden, sollen unter Umständen kurzzeitig auf der Artifactory gespeichert werden. (Natürlich wollen wir keine Datenleichen.)
